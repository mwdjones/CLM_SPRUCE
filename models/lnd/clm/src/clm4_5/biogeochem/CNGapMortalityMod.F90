...
#if(defined MICROBE)
   real(r8), pointer :: m_frootc_to_doc(:)
   real(r8), pointer :: m_frootn_to_don(:)
#endif
...
#if(defined MICROBE)
   m_frootc_to_doc        => pcf%m_frootc_to_doc
   m_frootn_to_don        => pnf%m_frootn_to_don
#endif
...
! local pointers to implicit in scalars
   ...
   real(r8), pointer :: litter_c_to_doc(:,:)
   real(r8), pointer :: litter_n_to_don(:,:)
#endif
   real(r8), pointer :: m_livestemc_xfer_to_litter(:)
   real(r8), pointer :: m_deadstemc_xfer_to_litter(:)
   real(r8), pointer :: m_livecrootc_xfer_to_litter(:)
...
#if(defined MICROBE)
   litter_c_to_doc => ccf%litter_c_to_doc
   litter_n_to_don => cnf%litter_n_to_don
#endif
...
#if(defined MICROBE)   
!write(*,*)" doc debug 1", litter_c_to_doc(c,j), c,j,p," litter_c_to_doc ", m_frootc_to_doc(p)
                  litter_c_to_doc(c,j) = litter_c_to_doc(c,j) + &
                       m_frootc_to_doc(p) * wtcol(p) * froot_prof(p,j)
!write(*,*)" doc debug 2", litter_c_to_doc(c,j), c,j,p," litter_c_to_doc ", m_frootc_to_doc(p)
#endif
...
#if(defined MICROBE)                  
                  litter_n_to_don(c,j) = litter_n_to_don(c,j) + &
                       m_frootn_to_don(p) * wtcol(p) * froot_prof(p,j)
!		       write(*,*)" don debug 1", litter_n_to_don(c,j), " litter_n_to_don ", m_frootn_to_don(p)
#endif
