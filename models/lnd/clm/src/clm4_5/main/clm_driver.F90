...
#ifndef CPL_BYPASS
  call ndep_interp()   !DMR note:  Very expensive even for single point datasets.
#endif
#ifndef NOFIRE
  call CNFireInterp()  !DMR note:  Very expensive - disable if no fire.
#endif
#endif
